...
def main():
    ...
    lines.append(r"\begin{longtable}{l >{\raggedright\arraybackslash}p{2.6cm} crrrrr}")
    ...
    lines.append(r"\multicolumn{8}{l}{\small\itshape "
    ...
    lines.append(r"\midrule")
    lines.append(r"\multicolumn{8}{r}{\small\itshape continued on next page}\\")
